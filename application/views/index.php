  ...
  <div class="navcontainer container">
    <div class="row upper-row">
      ...
      <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 texts text-right hidden-xs">
        <p >
          <span class="akzidenz ag-light s15 white">Atención y contacto: 52 (33) 3125-2200</span><br>
        </p>
  ...
  <div class="main-header">
    <div class="container">
      <div class="col-lg-8 col-md-10 col-sm-12 col-xs-12 col-lg-offset-2 col-md-offset-1">
        ...
        <p class="text-center">
          <span class="akzidenz ag-light s25 shadow">¡Conéctate con tu entorno profesional como nunca antes!</span>
        </p>
      </div>
    </div>
  </div>
